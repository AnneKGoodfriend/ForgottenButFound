...
// our db model
var Found = require("../models/model.js");
...
router.post('/api/create', function(req, res){
    ...
    geocoder.geocode(location, function (err,data) {
      ...
      found.save(function(err,data){
        ...
        if (err){
          var error = {status:'ERROR', message: 'Error saving object'};
...
//   Found.findById(requestedId, function(err,data){

//     // if err or no user found, respond with error 
//     if(err || data == null){
//       var error = {status:'ERROR', message: 'Could not find that object'};
//        return res.json(error);
//     }
...
router.get('/api/get', function(req, res){
  ...
  Found.find(function(err, data){
    // if err or no animals found, respond with error 
    if(err || data == null){
      var error = {status:'ERROR', message: 'Could not find object'};
      return res.json(error);
    }
